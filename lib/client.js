window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function SettingsPanel(props) {
			...
			const inputStyle = { width: '100px', padding: '6px 10px', border: '1px solid #d9d9d9', borderRadius: '6px', fontSize: '14px', boxSizing: 'border-box' };
